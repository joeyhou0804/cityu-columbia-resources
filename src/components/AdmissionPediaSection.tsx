...
const DEFAULT_BOTTOM_TOOLTIP = {
  en: 'Please refer to the Simplified Chinese version.',
  zh_cn: '请参考简体中文版。',
  zh_hk: '請參考簡體中文版。',
};
...
> = {
  en: {
    cityu: {
      show: true,
      enabled: true,
      href: '/pdfs/2019/en/volume_cityu.pdf',
    ...
    columbia: {
      show: true,
      enabled: false,
      href: '/pdfs/2019/en/volume_columbia.pdf',
      label: 'Volume of Columbia',
      topTooltipEnabled: true,
      topTooltipLabel: DEFAULT_TOP_TOOLTIP.en,
  ...
  'zh-cn': {
    cityu: {
      show: true,
      enabled: true,
      href: '/pdfs/2019/zh-cn/volume_cityu.pdf',
      label: '城大卷',
      topTooltipEnabled: false,
    ...
    columbia: {
      show: true,
      enabled: true,
      href: '/pdfs/2019/zh-cn/volume_columbia.pdf',
      label: '哥大卷',
      topTooltipEnabled: true,
      topTooltipLabel: DEFAULT_TOP_TOOLTIP.zh_cn,
      bottomTooltipEnabled: false,
  ...
  'zh-hk': {
    cityu: {
      show: true,
      enabled: true,
      href: '/pdfs/2019/zh-hk/volume_cityu.pdf',
      label: '城大卷',
      topTooltipEnabled: false,
    ...
    columbia: {
      show: true,
      enabled: true,
      href: '/pdfs/2019/zh-hk/volume_columbia.pdf',
      label: '哥大卷',
      topTooltipEnabled: true,
      topTooltipLabel: DEFAULT_TOP_TOOLTIP.zh_hk,
      bottomTooltipEnabled: false,
