      ...
      <>
        ...
        <div className="relative z-20">
          <div className="absolute inset-0 -z-10 overflow-hidden">
            <VideoWithFallback src="/videos/background3.mp4" fallbackSrc="/images/background3.jpg" className="w-full h-full object-cover" />
        ...
        <div ref={sectionRef} className="relative z-20" style={{ height: `${mobileCarouselHeight}px` }}>
          <div className="sticky top-0 h-screen overflow-hidden">
            <VideoWithFallback src="/videos/background3.mp4" fallbackSrc="/images/background3.jpg" className="absolute inset-0 w-full h-full object-cover" />
            <div className="absolute inset-0 bg-black bg-opacity-60" />
