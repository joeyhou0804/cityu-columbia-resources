...
export default function HomePage({ params: { locale } }: Props) {
  ...
  const admissionPediaContent = {
    ...
    'zh-hk': {
      ...
      bodyFont: 'ChironSungHK Regular, serif',
      paragraph1: '2017級（2019年入讀哥大）的內地生同學們，在到達哥大後的一個學期裡，合作編寫了兩冊《報讀百科》。《報讀百科》包括報讀雙學位項目前和獲得錄取後的主要準備過程，對於當時必要的報名流程有詳細的介紹和說明，還穿插配合了同學們的建議與提醒，可以供有意報讀的同學和家長們參考。',
      paragraph2: '《報讀百科》的編寫由2017級（2019年入讀哥大）侯江天同學發起並主導，在同屆內地同學方毅劼、李聞達、石啟蒙、涂振峰、王涵一的合作配合下，經城大商學院審稿與支持後，公開發布。簡體中文版的《報讀百科》同時發佈在城大內地學生學者聯誼會本科部（CSSAUG）微信公眾號。'
    }
  };
